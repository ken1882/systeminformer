...
typedef struct _POOL_ITEM
{
    ...
    PH_UINT64_DELTA AllocsDelta;
    PH_UINT64_DELTA FreesDelta;
    PH_UINT64_DELTA CurrentDelta;
    PH_UINT64_DELTA TotalSizeDelta;
...
typedef enum _POOLTAG_TREE_COLUMN_ITEM_NAME
{
    ...
    TREE_COLUMN_ITEM_ALLOC,
    TREE_COLUMN_ITEM_FREE,
    TREE_COLUMN_ITEM_CURRENT,
    TREE_COLUMN_ITEM_TOTAL,
    ...
    TREE_COLUMN_ITEM_ALLOCDELTA,
    TREE_COLUMN_ITEM_FREEDELTA,
    TREE_COLUMN_ITEM_CURRENTDELTA,
    TREE_COLUMN_ITEM_TOTALDELTA,
...
typedef struct _POOLTAG_ROOT_NODE
{
    ...
    PPH_STRING AllocsValueString;
    PPH_STRING FreesValueString;
    PPH_STRING CurrentValueString;
    PPH_STRING TotalSizeValueString;
    ...
    PPH_STRING AllocsDeltaString;
    PPH_STRING FreesDeltaString;
    PPH_STRING CurrentDeltaString;
    PPH_STRING TotalSizeDeltaString;
